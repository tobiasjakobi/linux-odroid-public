...
static const struct samsung_pll_rate_table exynos4x12_apll_rates[] __initconst = {
	PLL_35XX_RATE(24 * MHZ, 1800000000, 300, 4, 0),
...
static const struct samsung_pll_rate_table exynos4x12_vpll_rates[] __initconst = {
	...
	PLL_36XX_RATE(24 * MHZ, 243000000,  20, 1, 1, 16384),
	PLL_36XX_RATE(24 * MHZ, 229500000,  19, 1, 1,  8192),
	PLL_36XX_RATE(24 * MHZ, 202500000, 101, 3, 2, 16384),
	PLL_36XX_RATE(24 * MHZ, 160000000, 160, 3, 3,     0),
	PLL_36XX_RATE(24 * MHZ, 148500000,  74, 3, 2, 16384),
	PLL_36XX_RATE(24 * MHZ, 135000000,  22, 1, 2, 32768),
	PLL_36XX_RATE(24 * MHZ, 108000000,  54, 3, 2,     0),
	PLL_36XX_RATE(24 * MHZ, 106031250,  53, 3, 2,  1024),
	PLL_36XX_RATE(24 * MHZ,  85500000,  28, 1, 3, 32768),
	PLL_36XX_RATE(24 * MHZ,  78750000,  39, 3, 2, 24576),
	PLL_36XX_RATE(24 * MHZ,  74250000,  37, 3, 2,  8192),
	PLL_36XX_RATE(24 * MHZ,  65000000,  16, 3, 1, 16384),
	PLL_36XX_RATE(24 * MHZ,  53015625,  53, 3, 3,  1024),
	PLL_36XX_RATE(24 * MHZ,  49500000,  16, 1, 3, 32768),
	PLL_36XX_RATE(24 * MHZ,  40000000,  40, 3, 3,     0),
	PLL_36XX_RATE(24 * MHZ,  31500000,  21, 1, 4,     0),
	PLL_36XX_RATE(24 * MHZ,  25175003,  25, 3, 3, 11469),
	{ /* sentinel */ }
};
